#### This package is a fork of `kafkajs` with a fix for timeouts in pending tasks
###### This fork resolves issues related to negative timeout values in the request queue, ensuring smooth handling of throttling and pending requests.
